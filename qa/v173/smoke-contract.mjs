...
assert.ok(html.includes('/css/v173/production.css'),'Production visual stylesheet missing');
...
assert.ok(login.includes('v173-login-logo'),'production login logo missing');
assert.ok(login.includes('placeholder="Usuario"'),'production login field layout missing');
...
assert.ok(pan.includes('v173-panapass-side'),'production sidebar missing');
